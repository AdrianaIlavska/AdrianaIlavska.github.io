function initTable() {
    const data = [
      { Vedouci: 'Mgr. Zinaida Bechná, Ph.D. ', Oblast_expertizy: 'internal and ethnic conflicts, Caucasus, Russia, NATO ' , Pocet_praci: 14 },	
      { Vedouci: 'Mgr. et Mgr. Vladimir Bízik, Ph.D. ', Oblast_expertizy: 'Turkey, Middle East, Japan, technology in international relations ' , Pocet_praci: 6 },	
      ...
      { Vedouci: 'Mgr. et Mgr. Denis Janšta ', Oblast_expertizy: 'post-Soviet area, Russia, Czech/Slovak - Russian relations ' , Pocet_praci: 8 },	
      ...
      { Vedouci: 'prof. PhDr. Petr Kaniok, Ph.D. ', Oblast_expertizy: 'EU institutions; Euroscepticism; Scandinavia; parliamentarism ' , Pocet_praci: 10 },	
      ...
      { Vedouci: 'JUDr. Ing. Jan Lhotský, Ph.D., E.MA ', Oblast_expertizy: 'human rights; international law; democracy; international courts ' , Pocet_praci: 9 },	
      { Vedouci: 'RNDr. Petr Marek, Ph.D. ', Oblast_expertizy: 'regional geography, regional identity, regionalism, Europe ' , Pocet_praci: 7 },	
      { Vedouci: 'Mgr. Lenka Martínková ', Oblast_expertizy: 'Middle East; Iran; Saudi Arabia ' , Pocet_praci: 5 },	
      ...
      { Vedouci: 'doc. PhDr. Markéta Pitrová, Ph.D. ', Oblast_expertizy: 'EU integration; EU institutions; lobbying ' , Pocet_praci: 4 },	
      ...
      { Vedouci: 'Zuzana Ringlerová, Ph.D. ', Oblast_expertizy: 'Public opinion; Electoral behaviour; USA: domestic politics ' , Pocet_praci: 11 },	
      ...
      { Vedouci: 'Ing. Mgr. Petr Svatoň ', Oblast_expertizy: 'US-China relations, Chinese economy, economic theories and history ' , Pocet_praci: 12 },	
      ...
      { Vedouci: 'doc. PhDr. Tomáš Vlček, Ph.D. ', Oblast_expertizy: 'Energy security; Central and Eastern Europe; Energy policy; Nuclear energy ' , Pocet_praci: 10 },	
      { Vedouci: 'Mgr. Vladimir Vučković, Ph.D. ', Oblast_expertizy: 'Western Balkans, EU enlargement, geopolitics, populism ' , Pocet_praci: 8 }
      ];
